...
public class InstructionItemSlots : MonoBehaviour, IDropHandler {
	...
	public void OnDrop(PointerEventData eventData) {
    	eventData.pointerDrag.GetComponent<InstructionDragDrops>().droppedOnSlot = true;
        Debug.Log("OnDrop");
        ...
        if (eventData.pointerDrag != null) {
	    	...
	    	Debug.Log(intTag);
	    	InstructionGV.currentTagItem = intTag;
        }
    }
}